...
type ContactFormData = z.infer<typeof contactFormeSchema>

const contactFormeSchema = z.object({
    name: z.string().min(3).max(300).nonempty(),
...
export const ContactForm = () => {    
    const { handleSubmit, register } = useForm<ContactFormData>({
        resolver: zodResolver(contactFormeSchema)
    })
            ...
            <div className="w-full max-w-[420px] mx-auto">
                ...
                >
                    ...
                    <textarea 
                        ...
                        className="w-full h-[138px] bg-gray-800 rounded-lg placeholder:text-gray-400 text-gray-50 p-4 focus:outline-none focus:ring-2 ring-emerald-600"
                        maxLength={500}
                        {...register('message')}
                    />
