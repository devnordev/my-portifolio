...
export const ProjectCard = () => {
    return(
        <div className="rounded-lg h-[436px] flex flex-col bg-gray-800 overflow-hidden border-2 border-gray-800 hover:border-emerald-500 transition-all opacity-70 hover:opacity-100 group">
            ...
            <div className="flex-1 flex flex-col p-8">
                ...
                <p className="mt-2 text-gray-400 line-clamp-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Atque itaque consequuntur doloremque aut delectus dignissimos odio facilis fuga quos sed.</p>
